...
public class SerializeFileSystemAccessor {
	...
	try {
	    ...
	    FileSystemAccessor bean = new FileSystemAccessor();
	    ...
	    String fileToCreate = topDir + System.getProperty("file.separator") + "com" + System.getProperty("file.separator") + "sun" + System.getProperty("file.separator") + "management" + System.getProperty("file.separator") + "mbeans"+ System.getProperty("file.separator") + "loading"+  System.getProperty("file.separator") + "FileSystemAccessor.ser" ;
